...
public class Run {
    public static void main(String[] args) {
        ...
        */
        ...
        Robot robot1 = new Robot(new ToshibaHead(), new SonyHand(), new SamsungLeg());
        robot1.action();
        robot1.getPrice();
        ...
        Robot robot3 = new Robot(new SonyHead(), new SamsungHand(), new ToshibaLeg());
        robot3.action();
        robot3.getPrice();


        if (robot1.price > robot2.price & robot1.price > robot3.price) {
            System.out.println("Самы дорогой робот под номером 1! \n");
        } else if (robot2.price > robot1.price & robot2.price > robot3.price) {
